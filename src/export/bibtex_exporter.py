"""
BibTeX Exporter für Academic Agent v2.1

Exportiert Papers als BibTeX-Einträge für LaTeX.
...
def export_bibtex(papers: List[Dict[str, Any]], output_path: Path) -> None:
    ...
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write("% Bibliography - Generated by Academic Agent v2.1\n\n")
