"""
Markdown Exporter für Academic Agent v2.1
    ...
    with open(output_path, 'w', encoding='utf-8') as f:
        ...
        if quotes:
            ...
            for i, quote in enumerate(quotes, 1):
                ...
                f.write(f"   *— Page {quote.get('page', 'N/A')}*\n\n")

        # Footer
        f.write(f"---\n\n")
        f.write(f"*Generated by Academic Agent v2.2*\n")

    print(f"✅ Exported Markdown summary to {output_path}")
