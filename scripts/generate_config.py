...
def generate_config(
    ...
    if mode not in RESEARCH_MODES:
        ...
        print(f"Available modes: {', '.join(RESEARCH_MODES.keys())}")
        sys.exit(1)
...
**Config Version:** 2.1 (Interactive Mode)
...
"""
    ...
    print(f"🎯 Target: {mode_config['target_total']} sources")
    print(f"⏱️ Estimated: {get_estimated_duration(mode)}")
