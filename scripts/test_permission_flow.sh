...
EXPECTED_FILES=(
    "runs/$TEST_RUN_ID/run_config.json"
    ...
    "runs/$TEST_RUN_ID/metadata/downloads.json"
    "runs/$TEST_RUN_ID/metadata/quotes.json"
    "runs/$TEST_RUN_ID/metadata/research_state.json"
    "runs/$TEST_RUN_ID/output/Quote_Library.csv"
    "runs/$TEST_RUN_ID/output/quote_library.json"
    "runs/$TEST_RUN_ID/output/bibliography.bib"
    "runs/$TEST_RUN_ID/output/Annotated_Bibliography.md"
    "runs/$TEST_RUN_ID/output/search_report.md"
